...
| Family | Status |
|---|---|
| `prose/` | Phase 0–6 + 6.5 + 6.6 complete; Phase 8 in progress (batches 0/1/2a/2b done — 14 handcount detectors retired total). `prose init` CLI scaffolds book.editorial.yaml for new books. 50 detectors in `dispatch.run_registry`; `verdict.rollup_registry` emits red/yellow/green from preset-scaled thresholds. 241 tests green. See `prose/ROADMAP.md`. |
